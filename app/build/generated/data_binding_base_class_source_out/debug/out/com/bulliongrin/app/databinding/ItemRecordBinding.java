...
public final class ItemRecordBinding implements ViewBinding {
  ...
  private ItemRecordBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvAmount,
      @NonNull TextView tvDate, @NonNull TextView tvFrequency, @NonNull TextView tvNote) {
  ...
  public static ItemRecordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRecordBinding((MaterialCardView) rootView, tvAmount, tvDate, tvFrequency,
          tvNote);
    }
